...
import time
from client_api import connect_client, deposit, disconnect_client, withdraw, check_balance, list_transactions, check_balance

# initialize counter with current unix time
counter: int = int(time.time())
